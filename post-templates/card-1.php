        ...
        <div class="lbwp-post lbwp-post-template-card <?php echo esc_attr( implode( ' ', $wrapper_classes ) ); ?>" id="lbwp-item-<?php echo absint( $post_id ); ?>">
            ...
            <div class="uk-width-1-1">
                ...
                <div class="uk-flex uk-flex-between">
                    ...
                    <div class="uk-width-auto uk-margin-small-bottom uk-flex uk-flex-middle">

                        <?php if ( ! empty( $options['template_card_1_avatars'] ) ) : ?>

                            <div class="uk-margin-small-right uk-flex uk-flex-middle">

                                <?php echo get_avatar( get_the_author_meta( 'ID', get_post_field ( 'post_author', $post_id ) ), 40, '', '', ['class' => 'uk-border-circle uk-margin-small-bottom uk-margin-remove'] ); ?>
                    ...
                    <div class="uk-width-expand uk-margin-small-bottom uk-flex uk-flex-middle uk-flex-right">
            ...
            <div class="uk-width-expand">
                ...
                <?php if ( ( $local_headings_setting == 'show' ) || ( ( $local_headings_setting == 'global' || empty( $local_headings_setting ) ) && ! empty( $options['template_card_1_headings'] ) ) ) : ?>
                    ...
                    <div class="uk-margin-small-bottom">
                        ...
                        </<?php echo esc_attr( $options['template_card_2_heading_tag']); ?>>
